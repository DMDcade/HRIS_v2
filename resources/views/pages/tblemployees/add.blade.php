...
<?php
    $pageTitle = "Add New Tbl Employee"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Add New Tbl Employee</div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row ">
                <div class="col-md-9 comp-grid " >
                    <div  class="card card-1 border rounded page-content" >
                        <!--[form-start]-->
                        <form id="tblemployees-add-form" role="form" novalidate enctype="multipart/form-data" class="form page-form form-horizontal needs-validation" action="{{ route('tblemployees.store') }}" method="post">
                            @csrf
                            <div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-middlename-holder" class=" ">
                                                <input id="ctrl-middlename" data-field="middlename"  value="<?php echo get_value('middlename') ?>" type="text" placeholder="Enter Middlename"  required="" name="middlename"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-permanent_address-holder" class=" ">
                                                <input id="ctrl-permanent_address" data-field="permanent_address"  value="<?php echo get_value('permanent_address') ?>" type="text" placeholder="Enter Permanent Address"  required="" name="permanent_address"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-contact_number-holder" class=" ">
                                                <input id="ctrl-contact_number" data-field="contact_number"  value="<?php echo get_value('contact_number') ?>" type="text" placeholder="Enter Contact Number"  required="" name="contact_number"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-personal_email-holder" class=" ">
                                                <input id="ctrl-personal_email" data-field="personal_email"  value="<?php echo get_value('personal_email') ?>" type="email" placeholder="Enter Personal Email"  required="" name="personal_email"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-employee_id-holder" class=" ">
                                                <input id="ctrl-employee_id" data-field="employee_id"  value="<?php echo get_value('employee_id') ?>" type="text" placeholder="Enter Employee Id"  required="" name="employee_id"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-work_email-holder" class=" ">
                                                <input id="ctrl-work_email" data-field="work_email"  value="<?php echo get_value('work_email') ?>" type="email" placeholder="Enter Work Email"  required="" name="work_email"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-client_designation-holder" class=" ">
                                                <input id="ctrl-client_designation" data-field="client_designation"  value="<?php echo get_value('client_designation') ?>" type="text" placeholder="Enter Client Designation"  required="" name="client_designation"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-job_title-holder" class=" ">
                                                <input id="ctrl-job_title" data-field="job_title"  value="<?php echo get_value('job_title') ?>" type="text" placeholder="Enter Job Title"  required="" name="job_title"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-employee_type-holder" class=" ">
                                                <input id="ctrl-employee_type" data-field="employee_type"  value="<?php echo get_value('employee_type') ?>" type="text" placeholder="Enter Employee Type"  required="" name="employee_type"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-employee_status-holder" class=" ">
                                                <input id="ctrl-employee_status" data-field="employee_status"  value="<?php echo get_value('employee_status') ?>" type="text" placeholder="Enter Employee Status"  required="" name="employee_status"  class="form-control " />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div id="ctrl-date_hired-holder" class="input-group ">
                                                <input id="ctrl-date_hired" data-field="date_hired" class="form-control datepicker  datepicker"  required="" value="<?php echo get_value('date_hired') ?>" type="datetime" name="date_hired" placeholder="Enter Date Hired" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                <span class="input-group-text"><i class="material-icons">date_range</i></span>
                                            </div>
                                        </div>
                                    </div>

...
<?php
    $pageTitle = "Tbl Employee Details"; //set dynamic page title
?>
@extends($layout)
    ...
    <div  class="bg-light p-3 mb-3" >
        <div class="container">
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col  " >
                    <div class="">
                        <div class="h5 font-weight-bold text-primary">Tbl Employee Details</div>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div id="page-main-content" class=" px-3 mb-3">
                            ...
                            <div class="page-data">
                                ...
                                <div class="mb-3 row row justify-content-start g-0">
                                        ...
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    ...
                                                    <div class="fw-bold">
                                                        <?php echo  $data['permanent_address'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="bg-light mb-1 card-1 p-2 border rounded">
                                            <div class="row align-items-center">
                                                <div class="col">
                                                    <small class="text-muted">Date Regularization</small>
                                                    <div class="fw-bold">
                                                        <?php echo  $data['date_regularization'] ; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    <a class="btn btn-sm btn-success has-tooltip page-modal"   title="Edit" href="<?php print_link("tblemployees/edit/$rec_id"); ?>" >
                                    <i class="material-icons">edit</i> Edit
                                </a>
                                <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal" title="Delete" href="<?php print_link("tblemployees/delete/$rec_id?redirect=tblemployees"); ?>" >
